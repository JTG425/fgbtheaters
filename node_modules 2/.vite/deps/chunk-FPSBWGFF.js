    ...
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "fast-xml-parser" has been externalized for browser compatibility. Cannot access "fast-xml-parser.${key}" in client code. See https://vitejs.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var resolveS3ConfigAndInput = async (amplify, apiOptions) => {
  ...
  const { bucket, region, dangerouslyConnectToHttpEndpointForTesting } = ((_b = (_a = amplify.getConfig()) == null ? void 0 : _a.Storage) == null ? void 0 : _b.S3) ?? {};
...
var copyWithKey = async (amplify, input) => {
  ...
  const { keyPrefix: destinationKeyPrefix } = await resolveS3ConfigAndInput(amplify, input.destination);
...
//# sourceMappingURL=chunk-FPSBWGFF.js.map
